    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item"><a href="{{ url('/layanan') }}" class="nav-link {{ request()->is('layanan') ? 'active' : '' }}">Layanan</a></li>
          <li class="nav-item"><a href="{{ url('/kontak') }}" class="nav-link {{ request()->is('kontak') ? 'active' : '' }}">Kontak</a></li>
          <li class="nav-item"><a href="{{ url('/struktur') }}" class="nav-link {{ request()->is('struktur') ? 'active' : '' }}">Struktur</a></li>
